...
class load_ednet_DALOCB:
    def __init__(self):
        ...
        file_list = listdir("../data/ednet/KT1_sample/")
        user_dfs = []
        user_ids = []
        for filename in file_list:
            df = parse_data("../data/ednet/KT1_sample/" + filename)
            if df.shape[0] >= 1000:
                user_dfs.append(df)
        ...
        question_metadata = parse_data("../data/ednet/contents/questions.csv")
...
class load_eedi_DALOCB:
    def __init__(self):
        ...
        # Question metadata
        question_metadata_df = parse_data("../data/eedi/metadata/question_metadata_task_1_2.csv")
        ...
        # Subject metadata
        subject_metadata_df = parse_data("../data/eedi/metadata/subject_metadata.csv")
        ...
        # Training data    
        self.all_data_df = parse_data("../data/eedi/train_data/train_task_1_2.csv")

        #  User metadata
        user_metadata_df = parse_data("../data/eedi/metadata/student_metadata_task_1_2.csv")
