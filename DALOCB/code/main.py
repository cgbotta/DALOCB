import argparse
from algorithms import LOCB, DA_LOCB, DA_LOCB_Static
import numpy as np
import sys 
from load_data import load_eedi_LOCB, load_eedi_DALOCB, load_eedi_DALOCB_static, load_ednet_DALOCB, load_ednet_LOCB
...
if __name__ == '__main__':
    ...
    parser.add_argument('--experiment', default='movie', type=str, help='eedi_compare, ednet_compare, ednet_compare_cluster_size, ednet_compare_user_update_frequency, ednet_compare_cluster_update_frequency')
    ...
    if data == "eedi_compare":
        ...
        print("experiment is not defined. Run with --help for experiment options")
        sys.exit()
